...
type Props = {
  noteId: string
  deleteNoteLocally: (note: string) => void
}
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button
          className="absolute top-1/2 right-2 size-7 -translate-y-1/2 p-0 opacity-0 group-hover/item:opacity-100 [&_svg]:size-3 cursor-pointer"
          variant={'ghost'}
        >
          <Trash2 />
        </Button>
